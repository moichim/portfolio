...
function IndexPage(props: IndexPageProps, ref: IndexPageRef) {
    ...
    const loadScript = useCallback(() => {
        ...
        if (!hasScript()) {
            ...
            // script.src = "https://cdn.jsdelivr.net/npm/@labir/embed@1.2.62/dist/embed.min.js";
            script.innerHTML = "import labirembed from 'https://cdn.jsdelivr.net/npm/@labir/embed@1.2.62/+esm'"
            script.type = "module";
            script.id = SCIRPT_ID;
